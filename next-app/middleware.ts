...
const PUBLIC_ROUTES = ['/login', '/register', '/forgot-password', '/reset-password', '/verify-email', '/verify-receipt', '/approve', '/pending', '/rejected', '/join', '/manifest.webmanifest', '/sw.js'];
