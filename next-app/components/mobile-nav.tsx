 ...
 */
export function MobileNav({ isAdmin = false, isSupervisor = false, badges = {} }: { isAdmin?: boolean; isSupervisor?: boolean; badges?: Record<string, number> }) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <SidebarNav isAdmin={isAdmin} isSupervisor={isSupervisor} layoutIdSuffix="mobile" onNavigate={() => setOpen(false)} badges={badges} />
