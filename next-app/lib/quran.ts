...
const VERSES: DailyVerse[] = [
  ...
  { type: 'verse', arabic: 'وَتَعَاوَنُوا عَلَى الْبِرِّ وَالتَّقْوَىٰ…', english: 'Cooperate with one another in righteousness and piety…', urdu: 'نیکی اور تقویٰ میں ایک دوسرے کی مدد کرو…', reference: 'Al-Maidah 5:2' },
