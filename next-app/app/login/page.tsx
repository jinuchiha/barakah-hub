  ...
  return (
    <div className="mb-5 text-center">
      <svg viewBox="0 0 300 60" className="mx-auto w-48 opacity-60" aria-hidden="true">
        <line x1="10" y1="30" x2="100" y2="30" stroke="#c9a84c" strokeWidth="0.8" />
        <polygon points="120,10 130,30 120,50 110,30" fill="none" stroke="#c9a84c" strokeWidth="0.8" />
        <circle cx="150" cy="30" r="18" fill="none" stroke="#c9a84c" strokeWidth="0.8" />
        <circle cx="150" cy="30" r="8" fill="none" stroke="#c9a84c" strokeWidth="0.5" />
        <polygon points="180,10 190,30 180,50 170,30" fill="none" stroke="#c9a84c" strokeWidth="0.8" />
        <line x1="200" y1="30" x2="290" y2="30" stroke="#c9a84c" strokeWidth="0.8" />
      </svg>
    </div>
  );
}
      ...
      <svg viewBox="0 0 1200 900" className="size-full">
        <defs>
          <pattern id="geo" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            <polygon points="50,8 92,25 92,75 50,92 8,75 8,25" fill="none" stroke="#c9a84c" strokeWidth="0.6" />
